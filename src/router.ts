...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/observations/:id', name: 'observation', component: ObservationView, meta: { filters: false } },
    { path: '/timeline/:id', name: 'timeline', component: TimelineView, meta: { filters: false } },
